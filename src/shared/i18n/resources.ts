...
const zhCN = {
  common: {
    app: { title: 'Skills Manager Pro', home: 'Skills Manager Pro 首页', author: '暴论哥3.0（公众号同名）', authorName: '暴论哥3.0' },
    action: {
...
const enUS = {
  common: {
    app: { title: 'Skills Manager Pro', home: 'Skills Manager Pro home', author: 'Baolunge 3.0 (same name on WeChat)', authorName: 'Baolunge 3.0' },
